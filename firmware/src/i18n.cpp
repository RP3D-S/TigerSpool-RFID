...
/* S_READ_MODE      */ {{ "Scan", "Scan", "Scan", "Escanear", "Scansione", "Skanuj", "Digitalizar", "Digitalizar", "扫描" }},
/* S_READ_HINT      */ {{ "What is this?", "Qu'est-ce que c'est ?", "Was ist das?", "¿Qué es esto?", "Che cos'è?", "Co to jest?", "O que é isto?", "O que é isto?", "这是什么？" }},
